<template>
  <div class="memberP-container">
    <h2 class="memberP-title">
      돌고돌아서울 서비스 이용약관
    </h2>
    <br>
    <h3>제 1 장 총 칙</h3>
    <h4>제1조 목적</h4>
    이 약관은 돌고돌아서울 서비스(이하 "서비스"라 합니다)의 이용과 관련하여 현행 법령에 위반하지 않는 범위 내에서 회원의 기본적인 권리와 책임 및 당사와의 중요사항을 정하는 것을 목적으로 합니다.<br>
    <br>
    <h4>제2조 용어의 정의</h4>
    ...
    - '회사','서비스제공자'란 ' 돌고돌아서울과 계약된 별도서비스 운영자를 뜻합니다.<br>
    ...
    (3) '회원'가입은 반드시 본인의 정보를 통해야 하며, 타인의 명의와 개인정보를 무단으로 도용하거나 허위의 정보를 등록한 '회원'의 경우 '아이디'가 삭제되거나 관계법령에 따라 처벌을 받을 수
    있습니다.<br>
    (4) '회원'은 언제든지 실명, 주민등록번호, 아이디를 제외한 개인의 정보를 열람하고 수정할 수 있습니다.<br>
    (5) '회원'의 '아이디' 및 '비밀번호'의 관리 책임은 '회원'에게 있습니다. 이를 소홀히 관리하여 발생하는 '서비스'이용상의 손해 또는 제3자에 의한 무단이용 등에 대한 책임은 '회원' 본인에게 있으므로
    '서비스제공자'는 그에 대한 책임을 지지 않습니다.<br>
    ...
    (4) '서비스제공자'는 회원의 신상정보를 본인의 승낙없이 외부로 유출하지 않습니다. 단, 적법한 절차를 거친 국가기관의 요구나 수사상 또는 기타 공익을 위하여 필요하다고 인정되는 경우에는 예외로
    합니다.<br>
    (5) '서비스제공자'는 '회원'으로부터 제기된 의견이나 불만이 정당하다고 인정할 경우, 이를 처리하여야 합니다. '회원'이 제기한 의견이나 불만사항에 대해서 '회원'에게 처리과정 및 결과를
    전달합니다.<br>
    <br>
    <h4>제8조 회원의 의무</h4>
    ...
    (4) '서비스제공자'는 '게시물'등에 대하여 '정보통신망법' 및 '저작권법' 등 관련법에 위반되는 내용을 포함하는 경우, 권리자는 관련법이 정한 절차에 따라 '게시물'의 게시중단, 삭제 등을 요청할 수
    있으며,
    '서비스제공자'는 관련법에 따라 조치를 취하여야 합니다.<br>
    (5) '게시물'이 게시중단 된 경우, '게시물'을 등록한 '회원'은 재게시를 '서비스제공자'에 요청할 수 있습니다.<br>
    (6) '서비스제공자'는 회원이 등록한 게시물을 검색사이트나 다른 사이트에 노출할 수 있습니다. 또한, 회사가 제공하는 서비스 내에서 회원 게시물을 복제, 전시, 전송, 배포할 수 있으며 2차적 저작물과
    편집저작물로 작성 할 수 있습니다. 다만, 해당 게시물을 등록한 회원이 게시물의 삭제 또는 사용중지를 요청하면 회사는 관련 법률에 따라 보존해야 하는 사항을 제외하고 삭제 또는 사용을 중지합니다.<br>
    <br>
    <h4>제14조 게시물의 저작권</h4>
    ...
    (1) 상위 “회사(또는 웹사이트 등)”과 하위 “회사(또는 웹사이트 등)”가 하이퍼링크(예: 하이퍼링크의 대상에는 문자, 그림 및 동화상 등이 포함됨)방식 등으로 연결된 경우, 전자를 연결 “회사”이라고
    하고
    후자를 피연결 “회사”이라고 합니다.<br>
    (2) 연결“회사”는 피연결“회사”가 독자적으로 제공하는 &quot;재화 등&quot;에 의하여 &quot;이용자&quot;와 행하는 거래에 대해서 보증 책임을 지지 않는다는 뜻을 연결“회사”의 초기화면 또는
    연결되는 시점에 명시하기로 하고 그 거래에 대한 어떤 보증 책임도 지지 않습니다.<br>
    <br><br>
