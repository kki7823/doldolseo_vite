<template>
  <div class="memberR-container">
    <h2 class="memberR-title">
      돌고돌아서울 개인정보취급방침
    </h2>
    <br>
    돌고돌아서울은 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 개인정보보호법, 통신비밀보호법, 전기통신사업법, 등 정보통신서비스제공자가 준수하여야 할 관련 법령상의 개인정보보호 규정을 준수하며, 관련 법령에 의거한 개인정보취급방침을 정하여 이용자 권익 보호에 최선을 다하고 있습니다. <br>
    본 개인정보취급방침은 회사가 제공하는 스투비 및 스투비 관련 제반 서비스 이용에 적용되며 다음과 같은 내용을 담고 있습니다.<br>
    <br>
    <br>
    <h3>개요 </h3>
    <p>돌고돌아서울(이하 ‘회사'라 함)은 정보이용자(이하 ‘이용자'라 함)가 회사에서 제공하는  웹서비스, 모바일 어플리케이션 등 제반 서비스를 이용함에 있어, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 및 개인정보 보호법에 따라 이용자의 개인정보를 보호하고, 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같은 처리방침을 두고 있습니다.</p>
    <br/>
